...
public class Fila {
    ...
    void libeVoo() {
        ...
        if ("SIM".equals(resposta)) {
            System.out.println("O aviao " + ((Aviao) obj).nomeAviao + " com o codigo id: " + ((Aviao) obj).idAviao
    ...
    void exercicio3() {
        for (int i = 0; i <= filaAviao.size() - 1; i++) {
            Object obj = new Object();
            obj = filaAviao.get(i);
            System.out.println("O aviao " + ((Aviao) obj).nomeAviao + " esta na fila ocupando o " + (i + 1) + " lugar!");
        }
    }
    ...
    void exercicio5() {
        ...
        for (int i = 0; i <= topoFila - 1; i++) {
            System.out.println("O valor da fila na posicao " + i + " eh o: " + filaSorteio[i]);
        }
        System.out.println("\n");
        int j = 0;
        for (int i = topoPilha - 1; i >= 0; i--) {
            System.out.println("O valor da pilha na posicao " + j + " eh o: " + pilhaSorteio[i]);
            j++;
        }
    ...
    void exercicio7() {
        ...
        for (int i = 0; i <= fila3.length - 1; i++) {
            ...
            j++;
            topoFila++;
            System.out.println("Esta eh a fila sem inverter = " + fila3[i]);
        }
        System.out.println("----------");
        ...
        for (int i = fila3.length - 1; i >= 0; i--) {
            ...
            topoFila--;
            System.out.println("Esta eh a fila apos inverter = " + pilha3[i]);
        }
